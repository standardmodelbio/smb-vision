...
class VisionTrainer(Trainer):
    def __init__(self, *args, **kwargs):
        super(VisionTrainer, self).__init__(*args, **kwargs)
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.merger_lr is not None:
                ...
                merger_parameters = [name for name, _ in opt_model.named_parameters() if "classifier" in name]
    ...
    def _save_checkpoint(self, model, trial):
        ...
        if self.args.lora_enable:
            ...
            super(VisionTrainer, self)._save_checkpoint(model, trial)
