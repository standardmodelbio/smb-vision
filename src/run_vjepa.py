...
""" Pre-training a 🤗 Transformers model for video-jepa.
...
class VJEPATrainer(Trainer):
    def __init__(self, *args, **kwargs):
        ...
        self.compute_loss_func = nn.L1Loss()
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        # Compute L1 loss
        loss = self.compute_loss_func(predicted_target, target)
...
def collate_fn(examples):
    ...
    return {"pixel_values_videos": pixel_values, "context_mask": [context_mask], "target_mask": [target_mask]}
